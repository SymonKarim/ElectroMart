    ...
    <div className="allProducts">
      <Container>
        <h2 className="products__title">
          Latest <span className="text-warning">Collection</span>
        </h2>
        <p className="text-center text-muted products__subtitle">
          ElectroMart is an e-commerce website developed for selling Electronic
          gadgets and accessories specially laptops, personal computers and
          smartphones. At the beginning, we are focusing on selling laptops
          later we will start to sell other electronic products. Buy our
          products and lets us Grow..
        </p>
        <Row>
